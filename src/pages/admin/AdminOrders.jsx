    ...
    <AdminLayout title="Orders" subtitle="All customer orders in one place.">
      <div className="space-y-6">
        ...
        {loading ? (
          ...
          <div className="rounded-3xl border border-dashed border-zinc-800 bg-zinc-900 p-10 text-center text-zinc-400">
                    ...
                    <div className="mt-4 space-y-3 border-t border-zinc-800 pt-4">
                      {items.length === 0 ? (
                        ...
                        items.map((item, index) => (
                          <div key={index} className="rounded-2xl border border-zinc-800 bg-zinc-900 p-4 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
                            <div>
