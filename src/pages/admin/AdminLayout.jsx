  ...
  return (
    <div className="min-h-screen bg-gray-950 text-white">
      <div className="lg:flex lg:min-h-screen">
        <aside className="hidden lg:flex w-[260px] flex-col bg-zinc-950 border-r border-zinc-800 p-6">
          <div className="mb-10">
          ...
          <div className="mt-8 border-t border-zinc-800 pt-6 space-y-3">
            <button
              type="button"
              onClick={() => navigate('/')}
              className="flex items-center gap-3 w-full rounded-xl px-4 py-3 text-sm text-zinc-400 hover:bg-zinc-800 hover:text-white transition"
            >
        ...
        <div className="lg:hidden border-b border-zinc-800 bg-zinc-950 px-4 py-3 flex items-center justify-between">
          <button
            type="button"
          ...
          <div className="rounded-full bg-zinc-900 p-2 text-zinc-300">
            <Settings size={20} />
          </div>
        </div>
        ...
        {drawerOpen && (
          <div className="fixed inset-0 z-50 flex">
            ...
            <aside className="relative z-50 w-72 bg-zinc-950 border-r border-zinc-800 p-6">
        ...
        <main className="flex-1 bg-gray-950 px-4 py-6 lg:px-8 lg:py-8">
          <div className="mb-8">
