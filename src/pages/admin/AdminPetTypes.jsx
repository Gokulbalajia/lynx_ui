            ...
            <tbody>
              {loading ? (
                ...
                filteredTypes.map((typeItem) => (
                  <tr key={typeItem.id} className="border-b border-zinc-800 hover:bg-zinc-950/70 transition-colors">
            ...
            <form onSubmit={handleCreateOrUpdate} className="space-y-4">
              ...
              <div className="flex items-center gap-3">
                <input
                  ...
                  id="pet-type-active"
                  className="h-4 w-4 rounded border-zinc-700 bg-zinc-900 text-pink-500 focus:ring-pink-500"
                />
              ...
              <div className="flex items-center gap-3">
                ...
                >
                  ...
                  {editingItem ? 'Save Pet Type' : 'Create Pet Type'}
                </button>
                <button
                  type="button"
                  onClick={() => {
